package com.gitee.xiezengcheng.fluent.jpa.helper;
...
public class QueryHelper {
    ...
    public static <T, Q> Predicate toPredicate(Root<T> root, Q query, CriteriaBuilder cb) {
        return toPredicate(root, query, cb, true);
    }

    public static <T, Q> Predicate toPredicateOr(Root<T> root, Q query, CriteriaBuilder cb) {
        return toPredicate(root, query, cb, false);
    }


    private static <T, Q> Predicate toPredicate(Root<T> root, Q query, CriteriaBuilder cb, boolean type) {
