...
import com.gitee.xiezengcheng.fluent.jpa.bean.Query;
import com.gitee.xiezengcheng.fluent.jpa.reflection.ReflectionUtil;
import com.gitee.xiezengcheng.fluent.jpa.reflection.SerializableFunction;
...
public abstract class PredicateWrapper<E> {
    ...
    public <T, R> PredicateWrapper equal(SerializableFunction<T, R> propName, R value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.EQUAL, ReflectionUtil.getFieldName(propName), value));
        return this;
    }
    ...
    public <T, R> PredicateWrapper gt(SerializableFunction<T, R> propName, Comparable value) {
        ...
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.GREATER_THAN, ReflectionUtil.getFieldName(propName), value));
        return this;
    }


    public <T, R> PredicateWrapper gte(SerializableFunction<T, R> propName, Comparable value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.GREATER_THAN_EQ, ReflectionUtil.getFieldName(propName), value));
        return this;
    }

    public <T, R> PredicateWrapper lt(SerializableFunction<T, R> propName, Comparable value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.LESS_THAN, ReflectionUtil.getFieldName(propName), value));
        return this;
    }


    public <T, R> PredicateWrapper lte(SerializableFunction<T, R> propName, Comparable value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.LESS_THAN_EQ, ReflectionUtil.getFieldName(propName), value));
        return this;
    }


    public <T, R> PredicateWrapper innerLike(SerializableFunction<T, R> propName, String value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.INNER_LIKE, ReflectionUtil.getFieldName(propName), value));
        return this;
    }

    public <T, R> PredicateWrapper leftLike(SerializableFunction<T, R> propName, String value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.LEFT_LIKE, ReflectionUtil.getFieldName(propName), value));
        return this;
    }


    public <T, R> PredicateWrapper rightLike(SerializableFunction<T, R> propName, String value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.RIGHT_LIKE, ReflectionUtil.getFieldName(propName), value));
        return this;
    }

    public <T, R> PredicateWrapper in(SerializableFunction<T, R> propName, List<R> values) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.IN, ReflectionUtil.getFieldName(propName), values));
        return this;
    }

    public <T, R> PredicateWrapper notIn(SerializableFunction<T, R> propName, List<R> values) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.NOT_IN, ReflectionUtil.getFieldName(propName), values));
        return this;
    }

    public <T, R> PredicateWrapper between(SerializableFunction<T, R> propName, Comparable value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.BETWEEN, ReflectionUtil.getFieldName(propName), value));
        return this;
    }


    public <T, R> PredicateWrapper notNull(SerializableFunction<T, R> propName, R value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.NOT_NULL, ReflectionUtil.getFieldName(propName), value));
        return this;
    }

    public <T, R> PredicateWrapper isNull(SerializableFunction<T, R> propName, R value) {
        list.add(Query.build(com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type.IS_NULL, ReflectionUtil.getFieldName(propName), value));
        return this;
    }
    ...
    public <T, R> PredicateWrapper join(SerializableFunction<T, R> joinName,
                                        ...
                                        R value,
                                        com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Join join,
                                        com.gitee.xiezengcheng.fluent.jpa.annotation.Query.Type type) {
